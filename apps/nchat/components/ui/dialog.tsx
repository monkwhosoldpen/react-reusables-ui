    ...
    <DialogPortal hostName={portalHost}>
      <DialogOverlay>
        <DialogPrimitive.Content
          ref={ref}
          className={cn(
            'max-w-lg gap-4 border border-border bg-background shadow-lg rounded-t-lg',
            'web:duration-300 web:ease-out',
            open
              ? 'web:animate-in web:slide-in-from-bottom'
              : 'web:animate-out web:slide-out-to-bottom',
            className
          )}
          {...props}
        >
