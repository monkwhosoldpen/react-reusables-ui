...
export function LoginDialog({ isOpen, onOpenChange, onLoginSuccess }: LoginDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="w-full max-w-[400px] p-0 m-0 bg-white dark:bg-gray-900 rounded-2xl shadow-lg">
        <SafeAreaView>
            ...
            <View className="p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg">
              ...
              <View className="flex-row items-center mb-6">
                <View className="w-12 h-12 rounded-full justify-center items-center mr-3 bg-blue-100 dark:bg-blue-900/20 shadow-sm">
                  <MaterialIcons name="login" size={24} className="text-blue-500" />
                </View>
                <View className="flex-1">
